...
function EditAccommodationPage() {
  ...
  useEffect(() => {
    const fetchAccommodation = async () => {
      try {
        const response = await axios.get(`https://homelytics-project.onrender.com/edit/places/${id}`);
  ...
  const handleUpdate = async (updatedData) => {
    try {
      const response = await axios.put(`https://homelytics-project.onrender.com/places/update/${id}`, updatedData);
      if (response.data.success) {
