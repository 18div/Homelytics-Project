...
const socket = io('https://homelytics-project.onrender.com');
...
const ChatScreen = () => {
  ...
  const fetchChatMessages = async (chatId) => {
    try {
      const response = await fetch(`https://homelytics-project.onrender.com/chat/get/messages/${chatId}`);
  ...
  const fetchSenderName = async (senderId) => {
    try {
      const response = await fetch(`https://homelytics-project.onrender.com/find/byUserId/${senderId}`);
  ...
  const handleSend = async () => {
    try {
      const response = await fetch(`https://homelytics-project.onrender.com/chat/create/messages`, {
        method: "POST",
        headers: {
